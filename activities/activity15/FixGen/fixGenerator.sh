...
echo $INITIALLOGON >> logs/$LOGFILENAME
echo $INITIALLOGONACK >> logs/$LOGFILENAME
...
do
        ...
        echo $INITIALHEARTBEAT >> logs/$LOGFILENAME
        echo $INITIALHEARTBEATACK >> logs/$LOGFILENAME
...
do
        ...
        echo $NEWORDER >> logs/$LOGFILENAME
...
#set up the qty variables so we can acknowledge the message
        ...
        echo $NEWORDERACK >> logs/$LOGFILENAME
        ...
        do
                ...
                then
                        ...
                        echo $PARTIALFILL >> logs/$LOGFILENAME
                        ...
                        echo $CANCELREQUEST >> logs/$LOGFILENAME
                        let "CLIENTSEQNUMBER++"
                        ...
                        echo $PENDINGCANCEL >> logs/$LOGFILENAME
                        let "BROKERSEQNUMBER++"
                        ...
                        echo $CANCELACK >> logs/$LOGFILENAME
                        let "BROKERSEQNUMBER++"
                        FILLTEST=1;
        ...
        then
                ...
                echo $FULLYFILLED >> logs/$LOGFILENAME
        fi
